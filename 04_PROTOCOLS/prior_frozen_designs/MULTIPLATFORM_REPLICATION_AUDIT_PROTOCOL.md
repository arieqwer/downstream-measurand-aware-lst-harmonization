...
Requires a positive consensus physical signal that transfers to 2025, has low
cross-platform heterogeneity, and is supported by a replicated physical
mechanism. Measurement sensitivity alone is insufficient.

### Journal of Geophysical Research: Atmospheres

Requires a stable atmospheric/land-surface signal after harmonization and
temporal transfer, or a successful controlled physical mechanism experiment.

### Geo-spatial Information Science

The audit is potentially sufficient if at least two prespecified measurement
or replication sensitivities are supported by event-aware inference, the
effect sizes are practically material relative to the target signal, and all
null or contradictory tests are reported. The contribution would be a
replication-aware framework for geostationary urban thermal inference rather
than a universal drought mechanism.
